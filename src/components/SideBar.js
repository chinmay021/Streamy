...
const SideBar = () => {
  ...
  return isMenuOpen ? (
    <div className='sidebar2 border flex  flex-col w-[15rem]  h-[calc(100vh-4.625rem)] overflow-y-scroll overflow-x-hidden '>
      <div className='first-part flex pl-2 pr-6  pb-4 flex-col text-sm w-[15rem] '>
        ...
        <div className='shorts px-4  flex py-2 items-center  hover:bg-zinc-100 w-full rounded-lg cursor-pointer'>
          <img
            src={ShortsLogo}
            alt='shorts-logo'
        ...
        <div className='subscriptions py-2 px-4  flex items-center  hover:bg-zinc-100 w-full rounded-lg cursor-pointer'>
          <MdOutlineSubscriptions size='1.5rem' className='mb-1 mr-4' />
          <span>Subscriptions</span>
        </div>
        <div className='pt-3 border-b border-zinc-200 w-full'></div>
        <div className='library py-2 mt-4 px-4 flex items-center hover:bg-zinc-100 w-full rounded-lg  cursor-pointer'>
        ...
        <div className='Your-Videos py-2 px-4 flex items-center hover:bg-zinc-100 w-full rounded-lg  cursor-pointer'>
          <RiVideoLine size='1.5rem' className='mb-1 mr-4' />
          <span>Your videos</span>
        </div>
        <div className='Watch-Later py-2 px-4 flex items-center hover:bg-zinc-100 w-full rounded-lg  cursor-pointer'>
    ...
    <div className='sidebar pr-1 flex flex-col text-xs w-18 items-center  h-[calc(100vh-4.625rem)]'>
      <Link to='/'>
      ...
      <div className='shorts py-4 flex flex-col items-center  hover:bg-zinc-200 w-full rounded-md'>
        <img src={ShortsLogo} alt='shorts-logo' className='w-10 mb-1' />
        <span>Shorts</span>
      </div>
      <div className='subscriptions py-4 flex flex-col items-center  hover:bg-zinc-200 w-full rounded-md'>
        <MdOutlineSubscriptions size='1.5rem' className='mb-1' />
        <span>Subscriptions</span>
      </div>
      <div className='library py-4 flex flex-col items-center hover:bg-zinc-200 w-full rounded-md'>
